...
prompt('clique ENTER para continuar');                                    
console.clear(); 
...
let nk = 0; //variável usada nas últimas linhas, para nocaute.
...
function luta(){
     ...
     prompt(`Chegou o dia da grande luta. Você se prepapou para enfrentar um adversário potente. \n
     Cuidado!! Se sua energia ou sua resistência zerar, você será nocauteado! `)
    console.clear();
     
     prompt(`Boa sorte, o round 1 irá começar! `);
     console.clear();
    ...
    for(const round of rounds){
     ...
     prompt(`\n\n :::::::>>>>>> ROUND ${round} <<<<<<<<<<:::::::::      \n\n `.blue.bold );
    console.clear(); // mostra o round até 5
  ...
  if (nk < 1) {
		points(); //se não der nocaute, chama esse aqui a cada round
	}
   luta();
